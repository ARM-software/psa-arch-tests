...
TRANSITION_NS_TO_S(tbsa_status_t, val_firmware_version_update, uint32_t instace, uint32_t fw_ver_cnt);
TRANSITION_NS_TO_S(uint32_t,      val_firmware_version_read, uint32_t instance);
