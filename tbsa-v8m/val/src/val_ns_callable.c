...
TRANSITION_NS_TO_S(tbsa_status_t, val_nvram_read, uint32_t base, uint32_t offset, void *buffer, int size);
TRANSITION_NS_TO_S(tbsa_status_t, val_nvram_write, uint32_t base, uint32_t offset, void *buffer, int size);
...
TRANSITION_NS_TO_S(tbsa_status_t, val_crypto_revoke_key, uint32_t index, addr_t addr, size_t size);
TRANSITION_NS_TO_S(tbsa_status_t, val_fuse_ops, fuse_ops_t fuse_ops, addr_t addr, uint32_t *data, size_t size);
...
TRANSITION_NS_TO_S(tbsa_status_t, val_dpm_set_state, uint32_t index, dpm_status_t dpm_status, unlock_token_t unlock_token);
...
TRANSITION_NS_TO_S(tbsa_status_t, val_mpc_configure_security_attribute, uint32_t instance, addr_t start_addr,addr_t end_addr, mem_tgt_attr_t sec_attr);
...
TRANSITION_NS_TO_S(tbsa_status_t, val_crypto_validate_certificate, addr_t certificate_base_addr, addr_t public_key_addr, size_t certificate_size, size_t public_key_size);
TRANSITION_NS_TO_S(tbsa_status_t, val_crypto_get_uniqueID_from_certificate, addr_t certificate_base_addr, addr_t public_key_addr, size_t certificate_size, size_t public_key_size);
TRANSITION_NS_TO_S(tbsa_status_t, val_crypto_get_dpm_from_key, addr_t public_key_addr, size_t public_key_size, uint32_t *dpm_field);
TRANSITION_NS_TO_S(tbsa_status_t, val_crypto_get_dpm_from_certificate, addr_t certificate_base_addr, size_t certificate_size, uint32_t *dpm_field);
