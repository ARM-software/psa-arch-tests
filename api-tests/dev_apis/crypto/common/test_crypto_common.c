...
/* Deterministic EC */
uint8_t ec_keypair_deterministic[] = {
...
uint8_t sha_256_incorrect_hash[] = {
...
uint8_t ecdh_secp_256_r1_prv_key[ECDH_SECP_256_R1_PRV_KEY_LEN] = {
...
uint8_t ecdh_secp_256_r1_pub_key[ECDH_SECP_256_R1_PUB_KEY_LEN] = {
...
uint8_t ecdh_secp_384_r1_prv_key[ECDH_SECP_384_R1_PRV_KEY_LEN] = {
...
uint8_t ecdh_secp_384_r1_pub_key[ECDH_SECP_384_R1_PUB_KEY_LEN] = {
...
uint8_t aead_ciphertext_1[AEAD_CIPHERTEXT_LEN_1] = {
...
uint8_t signature_6[] = {0xC6, 0x54, 0x59, 0xB1, 0xC9, 0x50, 0x8F, 0xE6, 0xBD, 0x97, 0x3F,
...
uint8_t cmac_aes_128[] = {0x7F, 0x97, 0x9B, 0xA0, 0xFF, 0xF1, 0x35, 0x98, 0x61, 0x38, 0xF2,
                                0xAB, 0x05, 0x4B, 0x28, 0x4B};

/* test inputs */
uint8_t hash_input                               = 0xbd;
uint8_t input_bytes_data[INPUT_BYTES_DATA_LEN]   = "abcdefghijklmnop";
uint8_t input_salt[INPUT_SALT_LEN]               = "Salt";
uint8_t input_info[INPUT_INFO_LEN]               = "Info";
uint8_t input_seed[INPUT_SEED_LEN]               = "Seed";
uint8_t input_label[INPUT_LABEL_LEN]             = "Label";
