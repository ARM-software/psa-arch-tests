...
const client_test_t test_c066_crypto_list[] = {
    NULL,
    psa_key_derivation_input_integer_test,
    NULL,
};

int32_t psa_key_derivation_input_integer_test(caller_security_t caller __UNUSED)
{
    int32_t                        i, status;
