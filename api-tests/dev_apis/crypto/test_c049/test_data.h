...
{
    .test_desc          = "Test psa_mac_verify_multipart HMAC SHA 224\n",
    ...
    .data_size          = 8,
    .expected_mac       = {0x89, 0x6f, 0xb1, 0x12, 0x8a, 0xbb, 0xdf, 0x19, 0x68, 0x32,
...
{
    .test_desc          = "Test psa_mac_verify_multipart HMAC SHA 256\n",
    .key_type           = PSA_KEY_TYPE_HMAC,
    .usage              = PSA_KEY_USAGE_VERIFY_HASH,
    ...
    .data               = {0x48, 0x69, 0x20, 0x54, 0x68, 0x65, 0x72, 0x65},
    .data_size          = 8,
    .expected_mac       = {0xb0, 0x34, 0x4c, 0x61, 0xd8, 0xdb, 0x38, 0x53, 0x5c, 0xa8,
