...
const uint8_t invalid_userid[] = "abcdefghijklmnopq";
...
{
  .test_desc        = "Test psa_pake_set_user - JPAKE -SHA256\n",
...
{
  .test_desc        = "Test psa_pake_set_user - SPAKE2P HMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_set_user - SPAKE2P CMAC - SHA256 \n",
...
{
  .test_desc       = "Test psa_pake_set_user - SPAKE2P MATTER\n",
  .type            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data            = spake2p_key_pair,
  .data_length     = 64,
  .usage_flag      = PSA_KEY_USAGE_DERIVE,
...
#ifdef ARCH_TEST_JPAKE
{
  .test_desc        = "Test psa_pake_set_user - JPAKE-SHA256 - invalid user_id\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data             = input_password,
  .data_length      = INPUT_PASSWORD_LEN,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
{
  .test_desc        = "Test psa_pake_set_user - JPAKE-SHA256 - invalid user_id len\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data             = input_password,
  .data_length      = INPUT_PASSWORD_LEN,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
},
{
  ...
  .user_id_len      = sizeof(invalid_userid),
  .role             = PSA_PAKE_ROLE_NONE,
  .key_confirmation = 1,
...
#ifdef ARCH_TEST_SPAKE2P_CMAC
{
  .test_desc       = "Test psa_pake_set_user - SPAKE2P-CMAC - invalid user_id \n",
  .type            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data            = spake2p_key_pair,
  .data_length     = 64,
  .usage_flag      = PSA_KEY_USAGE_DERIVE,
...
#ifdef ARCH_TEST_SPAKE2P_HMAC
{
  .test_desc        = "Test psa_pake_set_user - SPAKE2P-HMAC - invalid user_id\n",
  .type             = PSA_KEY_TYPE_SPAKE2P_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_pub_key,
  .data_length      = 97,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
