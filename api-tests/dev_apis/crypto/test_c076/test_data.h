...
{
  .test_desc        = "Test psa_pake_abort - JPAKE -SHA256\n",
...
{
  .test_desc        = "Test psa_pake_abort - SPAKE2P HMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_abort - SPAKE2P CMAC - SHA256 \n",
  .type             = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_key_pair,
  .data_length      = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
{
  .test_desc        = "Test psa_pake_abort - SPAKE2P MATTER - SHA256 \n",
  .type             = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_key_pair,
  .data_length      = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
