...
{
  .test_desc        = "Test psa_pake_output - SPAKE2P HMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_output - SPAKE2P CMAC - SHA256 \n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
  .data2            = spake2p_key_pair,
  .data2_length     = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
{
  .test_desc        = "Test psa_pake_output - SPAKE2P MATTER\n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
...
#ifdef ARCH_TEST_SPAKE2P_HMAC
{
  .test_desc        = "Test psa_pake_output - SPAKE2P - buffer too small\n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
...
#ifdef ARCH_TEST_JPAKE
{
  .test_desc        = "Test psa_pake_output - JPAKE   - buffer too small\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data1            = input_password,
  .data1_length     = INPUT_PASSWORD_LEN,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
