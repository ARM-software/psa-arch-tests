...
{
  .test_desc        = "Test psa_pake_input - JPAKE-SHA256\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data1            = input_password,
  .data1_length     = INPUT_PASSWORD_LEN,
  .data2            = input_password,
  .data2_length     = INPUT_PASSWORD_LEN,
...
{
  .test_desc        = "Test psa_pake_input - SPAKE2P HMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_input - SPAKE2P CMAC - SHA256 \n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
...
{
  .test_desc        = "Test psa_pake_input - SPAKE2P MATTER \n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
...
#ifdef ARCH_TEST_SPAKE2P_HMAC
{
  .test_desc        = "Test psa_pake_input - SPAKE2P HMAC-SHA256 - invalid signature\n",
  .ctype            = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .stype            = PSA_KEY_TYPE_SPAKE2P_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1),
  .data1            = spake2p_key_pair,
  .data1_length     = 64,
  ...
  .peer_role        = PSA_PAKE_ROLE_SERVER,
  .key_confirmation = 0,
  .expected_status  = {PSA_SUCCESS, PSA_ERROR_INVALID_SIGNATURE}
},
#endif
#endif
#ifdef ARCH_TEST_JPAKE
{
  .test_desc        = "Test psa_pake_input - JPAKE-SHA256 - invalid signature\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data1            = input_password,
  .data1_length     = INPUT_PASSWORD_LEN,
  .data2            = input_password,
