...
const client_test_t test_c064_crypto_list[] = {
    NULL,
...
{
#if (defined(ARCH_TEST_MD2) || defined(ARCH_TEST_MD4) || defined(ARCH_TEST_MD5) || \
defined(ARCH_TEST_RIPEMD160) || defined(ARCH_TEST_SHA1) || \
...
{
#if (defined(ARCH_TEST_MD2) || defined(ARCH_TEST_MD4) || defined(ARCH_TEST_MD5) || \
     defined(ARCH_TEST_RIPEMD160) || defined(ARCH_TEST_SHA1) || defined(ARCH_TEST_SHA224) || \
     defined(ARCH_TEST_SHA256) || defined(ARCH_TEST_SHA384) || defined(ARCH_TEST_SHA512))
    ...
    val->print(TEST, "Check %d: ", g_test_count++);
    val->print(TEST, "Test psa_hash_suspend - repeated API call\n", 0);
