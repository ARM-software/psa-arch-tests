...
const client_test_t test_c073_crypto_list[] = {
    NULL,
    psa_pake_set_context_test,
    NULL,
};

extern  uint32_t g_test_count;

int32_t psa_pake_set_context_test(caller_security_t caller __UNUSED)
{
    ...
    for (i = 0; i < num_checks; i++)
    {
       ...
       /* Set context for the key exchange operation */
