...
const uint8_t invalid_peerid[] = "abcdefghijk123456";
...
{
  .test_desc        = "Test psa_pake_set_peer - JPAKE -SHA256\n",
...
{
  .test_desc        = "Test psa_pake_set_peer - SPAKE2P HMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_set_peer - SPAKE2P CMAC - SHA256 \n",
...
{
  .test_desc        = "Test psa_pake_set_peer - SPAKE2P MATTER\n",
  .type             = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_key_pair,
  .data_length      = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
#ifdef ARCH_TEST_JPAKE
{
  .test_desc        = "Test psa_pake_set_peer - JPAKE-SHA256 - invalid peer_id\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data             = input_password,
  .data_length      = INPUT_PASSWORD_LEN,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
{
  .test_desc        = "Test psa_pake_set_peer - JPAKE-SHA256 - invalid peer_id len\n",
  .type             = PSA_KEY_TYPE_PASSWORD,
  .data             = input_password,
  .data_length      = INPUT_PASSWORD_LEN,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
},
{
  ...
  .user_id          = userid,
  .user_id_len      = USER_ID_LEN,
  .peer_id          = invalid_peerid,
  .peer_id_len      = sizeof(invalid_peerid),
  .role             = PSA_PAKE_ROLE_NONE,
  .key_confirmation = 1,
...
#ifdef ARCH_TEST_SPAKE2P_CMAC
{
  .test_desc        = "Test psa_pake_set_peer - SPAKE2P CMAC-SHA256 - invalid peer_id\n",
  .type             = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_key_pair,
  .data_length      = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
...
#ifdef ARCH_TEST_SPAKE2P_MATTER
{
  .test_desc        = "Test psa_pake_set_peer - SPAKE2P HMAC-SHA256 - invalid peer_id\n",
  .type             = PSA_KEY_TYPE_SPAKE2P_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1),
  .data             = spake2p_key_pair,
  .data_length      = 64,
  .usage_flag       = PSA_KEY_USAGE_DERIVE,
