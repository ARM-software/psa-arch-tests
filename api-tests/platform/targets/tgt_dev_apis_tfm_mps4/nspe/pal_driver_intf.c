...
{
    return pal_wd_syswdog_init((addr_t) PLATFORM_WD_BASE, time_us, timer_tick_us);
}
...
{
    return pal_wd_syswdog_enable((addr_t) PLATFORM_WD_BASE);
}
...
{
    return pal_wd_syswdog_disable((addr_t) PLATFORM_WD_BASE);
}
