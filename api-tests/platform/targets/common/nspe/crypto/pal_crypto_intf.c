...
int32_t pal_crypto_function(int type, va_list valist)
{
    ...
    uint8_t                                  *output, *output1;
    size_t                                    output_size, output_size1;
    size_t                                    output_length, *p_output_length, *p_output_length1;
    size_t                                   *p_bits;
    psa_key_id_t                              key, id;
    ...
    case PAL_CRYPTO_KEY_ATTRIBUTES_INIT:
        ...
        memcpy((void *)attributes, (void *)&attributes_temp, sizeof(psa_key_attributes_t));
        return 0;
        break;
    ...
    case PAL_CRYPTO_MAC_OPERATION_INIT:
        ...
        memcpy((void *)mac_operation, (void *)&mac_operation_temp, sizeof(psa_mac_operation_t));
        return 0;
        break;
