...
#define UART_0_BASE                            0x40106000  // MUSCA_B1_UART1_NS_BASE
...
#define WATCHDOG_0_BASE                        0x50081000   // MUSCA_B1_CMSDK_WATCHDOG_S_BASE
...
#define WATCHDOG_0_TIMEOUT_IN_MICRO_SEC_LOW    20000000   //20.0  sec :  20 * 1000 * 1000
#define WATCHDOG_0_TIMEOUT_IN_MICRO_SEC_MEDIUM 20000000   //20.0  sec :  20 * 1000 * 1000
#define WATCHDOG_0_TIMEOUT_IN_MICRO_SEC_HIGH   20000000   //20.0  sec :  20 * 1000 * 1000
#define WATCHDOG_0_TIMEOUT_IN_MICRO_SEC_CRYPTO 20000000   //20.0 sec : 20 * 1000 * 1000

// Range of 1KB Non-volatile memory to preserve data over reset. Ex, NVRAM and FLASH
#define NVMEM_NUM                              1

#define NVMEM_0_START                          0x3003F800
#define NVMEM_0_END                            0x3003FBFF
...
#define NSPE_MMIO_0_START                  0x00200F00
#define NSPE_MMIO_0_END                    0x00200F1F
#define NSPE_MMIO_0_PERMISSION             TYPE_READ_WRITE

#define SERVER_PARTITION_MMIO_NUM          1

#define SERVER_PARTITION_MMIO_0_START      0x3003FC00
#define SERVER_PARTITION_MMIO_0_END        0x3003FD00
#define SERVER_PARTITION_MMIO_0_PERMISSION TYPE_READ_WRITE

#define DRIVER_PARTITION_MMIO_NUM          1

#define DRIVER_PARTITION_MMIO_0_START      0x3003FE00
#define DRIVER_PARTITION_MMIO_0_END        0x3003FF00
