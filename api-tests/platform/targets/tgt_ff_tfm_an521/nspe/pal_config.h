...
#define UART_0_BASE                            0x50202000  // UART2_S
...
#define WATCHDOG_0_BASE                        0x50081000   // APB_WATCHDOG_BASE_S
...
#define NVMEM_0_START                          0x102FFC00   // (FLASH0_BASE_S + FLASH0_SIZE - 0x400)
#define NVMEM_0_END                            0x102FFFFF
...
#define NSPE_MMIO_0_START                  0x00300F00
#define NSPE_MMIO_0_END                    0x00300F1F
#define NSPE_MMIO_0_PERMISSION             TYPE_READ_WRITE

#define SERVER_PARTITION_MMIO_NUM          1

#define SERVER_PARTITION_MMIO_0_START      0x3801FC00
#define SERVER_PARTITION_MMIO_0_END        0x3801FD00
#define SERVER_PARTITION_MMIO_0_PERMISSION TYPE_READ_WRITE

#define DRIVER_PARTITION_MMIO_NUM          1

#define DRIVER_PARTITION_MMIO_0_START      0x3801FE00
#define DRIVER_PARTITION_MMIO_0_END        0x3801FF00
